...
import test, { expect } from './Fixtures/basePages'; //TOTO JE IMPORTOVÁNO Z BASEPAGES TS, KDE JE TO DEFINOVÁNO testTomAT MAJÍCÍ LoginPage A HomePage MAJÍCÍ SPRÁVNÉ CESTY  A JAK MAJÍ PRACOVAT S PAGE OBJECTY - JSOU TAM OBSAŽENÉ TESTY PRO TOMAT A OVSAHEM JE I EXPECT -OČEKÁVÁNÍ
